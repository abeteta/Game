...
public class RespuestaResponse implements Serializable {
    ...
    public RespuestaResponse () {super();}

    public RespuestaResponse(Integer id_versus, Integer id_jugador, Integer id_curso, Integer id_pregunta, Integer id_respuesta, Boolean resultado_respuesta) {
